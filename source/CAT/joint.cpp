...
namespace CAT {
  ...
  double joint::calculate_chi2(joint j, cell A, cell B, joint * modified, bool A_is_on_gap, bool B_is_on_gap)const{
    // this: A B C
    // j:    0 A B

    experimental_double angle_AA, angle_BB, angle_phi, angle_theta;
    experimental_point pa = j.epb();
    experimental_point pb= this->epb();
